...
public class XpathTraversingPractice1 {
	...
	public static void main(String[] args) {
		...
		WebElement phone = driver.findElement(By.xpath("span[contains(text(),'Redmi 12C (Matte Black, 4GB RAM, 64GB Storage) | High Performance Mediatek Helio G85 | Big 17cm(6.71) HD+ Display with 5000mAh(typ) Battery')]/../../../../../..//span[@class='a-price-whole']"));
